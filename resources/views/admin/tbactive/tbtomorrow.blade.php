...
@section('content')
        ...
        <div class="col-lg-12 text-right">
            ...
            <div class="card card-chart">
                <div class="card-header">
                    <h5 class="card-category">اختيار جدول مباريات الغد </h5>
                    <form method="post" action="{{route('admin.tables.setTomorrow')}}">
                        @csrf
                        <div class="form-group col-12">
                            <label for="sel">الايام المجدولة :</label>
                            <select id="sel" name="tb_day_id" class="col-6">
                                @isset($tbDays)
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card ">
                <div class="card-header">
                    <h4 class="card-title text-right">  جدول مباريات الغد@isset($active -> tbDays)
